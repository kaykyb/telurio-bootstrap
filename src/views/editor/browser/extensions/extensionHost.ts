...
export default class ExtensionHost extends ViewComponent {
  ...
  constructor(commonService: CommonViewBrowserService) {
    super(commonService);

    this.extensionsDirs = this.commonService.getExtensions();
    this.loadExtensions();
  }
